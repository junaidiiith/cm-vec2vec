...
import json
import csv
importdef serialize_property(prop, parent_term, property_type_map, relationship_map):
    ...
    if prop_type_info is not None and isinstance(prop_type_info, dict):
        ...
        prop_type = property_type_map.get(prop_type_id, "Unknown type")ctions import defaultdict
